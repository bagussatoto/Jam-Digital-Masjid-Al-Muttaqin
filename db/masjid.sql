...
(1, 'Info Saldo Masjid', '<h1>Total saldo saat ini </h1>', 'Rp. <u>10.000.000</u>', '', '2017-07-06.jpg', 1),
(2, 'Pendaftaran Qurban 1443 H', 'Diinfokan kepada para jama\'ah Masjid Al Muttaqin bahwa pendaftaran qurban sudah dibuka. Harap mendaftarkan diri dengan panitia yang sudah terbentuk.', 'Biaya Qurban tahun ini  <i>Rp. 3.000.000<i>  /orang', '', 'Screenshot 2022-04-13 181524.jpg', 1),
(7, 'Buka Bersama Di Masjid Muttaqin', '<i>Selama bulan puasa, panitia menyediakan </i>\r\n', '<i>Makanan untuk berbuka puasa</i>', '', 'Screenshot 2022-04-13 180523.jpg', 1);
